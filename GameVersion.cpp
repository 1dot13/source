...
// ------------------------------
	...
	#ifdef JA2UB
		CHAR16 zVersionLabel[256]		= { L"Unfinished Business - Map Editor v1.13.5423 (Development Build)" }; 
	#else
		CHAR16 zVersionLabel[256]		= { L"Map Editor v1.13.5423 (Development Build)" }; 
	#endif
...
CHAR8		czVersionNumber[16]	= { "Build 12.07.25" };		//YY.MM.DD
