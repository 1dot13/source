...
STR16 pLandTypeStrings[] =
{
	...
	L"SAM导弹基地",	//"SAM site",
	L"反叛者隐蔽处",	//"Rebel Hideout", //The rebel base underground in sector A10
...
*/
	...
	L"到达该分区了", //"has arrived in sector", 
...
STR16 gzLateLocalizedString[] =
{
	...
	L"当前/最大进展： %d%%/%d%%",		//"Current/Max Progress: %d%%/%d%%",
