...
STR16	szCovertTextStr[]=
{
	...
	L"%s's %s ist misstrauisch!",
	L"%s's %s ist eine militätische Ausrüstung!",
	L"%s trägt zu viele Waffen!",
	L"%s's %s ist zu fortgeschriten für einen Soldaten dieser Armee!",
	...
	L"Bei genauerer Betrachtungweise ist %s's Verschleierungstaktik nicht wirksam!",
	L"%s sollte nicht hier sein!",
	L"%s sollte nicht hier sein zu dieser Zeit!",
	L"%s wurde in der nähe einer frischen Leiche gesichtet!",
	L"%s Ausrüstung lässt die Augenbrauchen hochgehen!",
	L"%s visiert %s an!",
	L"%s wurde gesehen durch %s's Verschleierung!",
	L"Keine Kleidungsgegenstände wuden in der Datei Items.xml gefunden!",
	...
	L"%s trägt eine unordentliche Uniform!",
	L"Im Nachhinein betrachtet, war das Angebot zur Aufgabe in der Verkleidung sicher nicht die beste Idee ...",
	L"%s wurde aufgedeckt!",
};
