...
STR16		zOptionsToggleText[] = 
{
	...
	L"Wymuú tryb turowy",			// arynn : add forced turn mode
};
...
STR16	zOptionsScreenHelpText[] =
{
	...
	L"Jeúli W£•CZONE i wrÛg jest obecny, \ntryb turowy jest w≥πczony, \ndopÛki sektor nie zostanie oczyszczony (|C|T|R|L+|S|H|I|F|T+|A|L|T+|T).",	// arynn : add forced turn mode
};
...
STR16 sRepairsDoneString[] =
{
	...
	L"%s zakoÒczy≥(a) naprawÍ ekwipunku oddzia≥u",
	L"%s zakoÒczy≥(a) naprawÍ ekwipunku oddzia≥u",
};
...
STR16 MPClientMessage[] =
{
	...
	L"Nowe po≥πczenie Client #%d - '%S', Edge: %d, Team: %d.",
