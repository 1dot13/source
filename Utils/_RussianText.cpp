...
STR16 pMilitiaString[] =
{
	...
	L"Здесь присутствуют ополченцы из других секторов. Распустить их по своим прежним позициям?",
};
...
STR16	zNewTacticalMessages[]=
{
	...
	L"В начале игры вы выбрали сохранение \"между боями\", по-этому нельзя сохранить игру во время боя.",
	...
	// anv: extra iron man modes
	L"В начале игры вы выбрали сохранение \"между перестрелками\", по-этому нельзя сохранить игру в пошаговом режиме.",
	L"В начале игры вы выбрали сохранение \"один раз в день\", по-этому сохранить игру можно лишь раз в сутки, в %02d:00.",
};
