...
//..L"---------------------------------------------------------------------v"
	...
	L"Показать подземные квадраты",
	L"Показать квадраты с заведениями\n[|Л|К|М] переключить фильтр\n[|П|К|М] сбросить фильтр",
	L"Показать другие квадраты",
};
...
CHAR16 Message[][STRING_LENGTH] =
{
	...
	L"В квадрате еще остались враги!",
...
STR16 pMilitiaString[] =
{
	...
	L"Здесь присутствуют ополченцы из других квадратов. Распустить их по своим прежним позициям?",
};
...
{
	// radio operator
	L"Вызвать артиллерийский удар из квадрата...",
	...
	L"Вызвать подкрепления из соседних квадратов.",
...
STR16 pTraitSkillsDenialStrings[] =
{
	...
	L" - позиции минометов в соседних квадратах\n",
...
STR16 pSnitchMenuDescStrings[] =
{
	...
	L"Взять задание в этом квадрате.",
	L"Отмена",
};
...
{
	L"%s собрал(а) слухи об активности противника в %d квадратах.",
...
{
	L"",	//Unused
	L"%s замечен в квадрате %c%d, и другой отряд уже на подходе.",	//STR_DETECTED_SINGULAR
	L"%s замечен в квадрате %c%d, и остальные отряды уже на подходе.",	//STR_DETECTED_PLURAL
	...
	L"КВАДРАТ",		//The Sector A9 part of the header		//STR_AR_SECTOR_HEADER
	...
	L"Перейти в квадрат",				//STR_PB_GOTOSECTOR_BTN,
	L"Уйти из квадрата",				//STR_PB_RETREATMERCS_BTN,
	...
	L"ВРАЖЕСКИЙ КВАДРАТ",				//STR_PB_ENTERINGENEMYSECTOR_HEADER
	...
	L"прибыл(а) в квадрат", 

	//These entries are for button popup help text for the prebattle interface.  All popup help
	//text supports the use of \n to denote new line.  Do not use spaces before or after the \n.
	L"Автоматически просчитывает бой\nбез загрузки карты. (|A)",
	L"Нельзя включить автобой\nво время нападения.",
	L"Войти в квадрат, чтобы атаковать врага. (|E)",
	L"Отступить отрядом в предыдущий квадрат. (|R)",				//singular version
	L"Всем отрядам отступить в предыдущий квадрат. (|R)", //multiple groups with same previous sector

	//various popup messages for battle conditions.  

	//%c%d is the sector -- ex:  A9
	L"Враги атаковали ваших ополченцев в квадрате %c%d.",
	//%c%d квадрат -- напр:  A9
	L"Твари атаковали ваших ополченцев в квадрате %c%d.",
	//1st %d refers to the number of civilians eaten by monsters,  %c%d is the sector -- ex:  A9
	//Note:  the minimum number of civilians eaten will be two.
	L"Твари убили %d гражданских во время атаки квадрата %s.",
	//%s is the sector location -- ex:  A9: Omerta
	L"Враги атаковали ваших наемников в квадрате %s. Ни один из ваших бойцов не в состоянии сражаться!",
	//%s is the sector location -- ex:  A9: Omerta
	L"Твари атаковали ваших наемников в квадрате %s. Ни один из ваших бойцов не в состоянии сражаться!",
...
CHAR16 TacticalStr[][ MED_STRING_LENGTH ] =
{
	...
	L"Идти в квадрат",
	L"Идти на карту",
	L"Этот квадрат отсюда покинуть нельзя.",
	L"Вы не можете покинуть квадрат в походовом режиме.",
	L"%s слишком далеко.",
	...
	L"Шахтер",
	L"Машина может ездить только между квадратами.",
...
STR16 pExitingSectorHelpText[] =
{
	...
	L"Если выбрано, то карта соседнего квадрата будет сразу же загружена.",
	L"Если выбрано, то вы автоматически попадете на экран карты,\nтак как путешествие займет некоторое время.",

	//If you attempt to leave a sector when you have multiple squads in a hostile sector.
	L"Этот квадрат оккупирован врагом, и вы не можете выйти отсюда.\nВы должны разобраться с этим, прежде чем перейти в любой другой квадрат.",

	//Because you only have one squad in the sector, and the "move all" option is checked, the "go to sector" option is locked to on. 
	//The helptext explains why it is locked.
	L"Как только оставшиеся наемники покинут этот квадрат,\nсразу будет загружен соседний квадрат.",
	L"Выведя оставшихся наемников из этого квадрата,\nвы автоматически попадете на экран карты,\nтак как на путешествие потребуется некоторое время.",

	//If an EPC is the selected merc, it won't allow the merc to leave alone as the merc is being escorted.  The "single" button is disabled.
	L"%s нуждается в сопровождении ваших наёмников и не может самостоятельно покинуть квадрат.",

	//If only one conscious merc is left and is selected, and there are EPCs in the squad, the merc will be prohibited from leaving alone.
	//There are several strings depending on the gender of the merc and how many EPCs are in the squad.
	//DO NOT USE THE NEWLINE HERE AS IT IS USED FOR BOTH HELPTEXT AND SCREEN MESSAGES!
	L"%s не может покинуть квадрат один, так как он сопровождает %s.", //male singular
	L"%s не может покинуть квадрат одна, так как она сопровождает %s.", //female singular
	L"%s не может покинуть квадрат один, так как он сопровождает группу из нескольких человек.", //male plural
	L"%s не может покинуть квадрат одна, так как она сопровождает группу из нескольких человек.", //female plural
	...
	L"Если выбрать, данный отряд отправится\nв место назначения, покинув этот квадрат.",

	//This strings is used BEFORE the "exiting sector" interface is created.  If you have an EPC selected and you attempt to tactically
	//traverse the EPC while the escorting mercs aren't near enough (or dead, dying, or unconscious), this message will appear and the
	//"exiting sector" interface will not appear.  This is just like the situation where
	//This string is special, as it is not used as helptext.  Do not use the special newline character (\n) for this string.
	L"%s сопровождается вашими наемниками и не может покинуть этот квадрат в одиночку. Остальные наемники должны быть рядом, прежде чем вы сможете покинуть квадрат.",
};
...
STR16 pMapInventoryErrorString[] =
{
	...
	L"%s вне этого квадрата, и не может подобрать предмет.",
	...
	L"%s вне этого квадрата и не может оставить предмет.",
...
STR16 pMapScreenFastHelpTextList[] =
{
	...
	L"Чтобы приказать наемнику перейти в другой квадрат, щелкните в колонке 'КУДА'.",
	L"Как только наемник получит приказ на передвижение, включится сжатие времени.",
	L"Нажатием левой кнопки мыши выбирается квадрат. Еще одно нажатие нужно, чтобы отдать наемникам приказы на передвижение. Нажатие правой кнопки мыши на квадрате откроет экран дополнительной информации.",
...
{
	L"Отправить наемников в квадрат", 	// title for movement box 
...
STR16 pMapScreenInvenButtonHelpText[] =
{
	...
	L"Закрыть инвентарь квадрата (|E|s|c)",	// exit sector inventory
...
STR16 pSkyriderText[] =
{
	...
	L"У Небесного Всадника нет пассажиров. Если вы хотите переправить бойцов в этот квадрат, посадите их в вертолет (приказ \"Транспорт/Вертолёт\")."
};
...
//11-15
	...
	L"Вы попали в засаду кошек-убийц в квадрате %s!",
	L"Вы только что вошли в квадрат %s... И наткнулись на логово кошек-убийц!", 
	L"", 
	L"База ПВО в %s была захвачена.",
//16-20
	L"Шахта в %s была захвачена врагом. Ваш дневной доход сократился до %s в день.",
	L"Враг занял без сопротивления квадрат %s.",
...
//26-30
	...
	L"Ополченцы вне границ города не могут перейти в другой квадрат.",
//31-35
...
//46-50
	...
	L"Внимание! Тренировать ополченцев в одном квадрате могут не более двух наемников.",
...
{
	L"Ещё раз щелкните по точке назначения, чтобы подтвердить путь, или щелкните по другому квадрату, чтобы установить больше путевых точек.",
...
STR16 pHistoryStrings[] =
{
	...
	L"Потерян контроль над квадратом",				//ENEMY_INVASION_CODE
...
{
	L"Вы потерпели поражение в этом квадрате!",
...
STR16		zMarksMapScreenText[] =
{
	...
	L"Здесь показано, куда ваши мобильные отряды могут пройти, и куда нет. СЕРЫЙ = не пойдут туда. КРАСНЫЙ = могут пойти туда, но вы запретили им. ЖЁЛТЫЙ = могут вступить в квадрат, но не могут его покинуть. ЗЕЛЁНЫЙ = могут свободно передвигаться. Правым щелчком кнопки мыши можно менять цветовой статус квадрата.",
...
{
	L"Отряд %d заметил кого-то в квадрате %s.",
	L"Отряд %s заметил кого-то в квадрате %s.",
};
...
STR16 pMilitiaConfirmStrings[] =
{
	...
	L"",	// unused
	L"Тренировка ополчения в квадрате %d будет стоить $%d. %s", // cost to train sveral sectors at once
	...
	L"Тренировка мобильного подразделения в квадрате %d обойдётся в $ %d. %s",
	...
	L"освободить больше городских квадратов", 
	L"освободить новые городские квадрата", 
...
#endif
	L"Если включено, при просмотре предметов квадрата в инвентаре бойца\nбудет доступно меню по нажатию левой кнопки на пустой карман.",
	L"Если включено, высвечивается примерное положение последних врагов в квадрате.",
...
STR16	gzGIOScreenText[] =
{
	...
	L"все сразу",
#endif
	L"Спрятанное оружие квадратов",	//Secret Weapon Caches
	L"выборочно",
	L"всё возможное",
...
STR16 pMessageStrings[] =
{
	...
	L"%s: прибыл в квадрат %s%s",//30	Name/Squad has arrived in sector A9.  Order must not change without notifying
//SirTech
	L"Версия",
	...
	L"%s прибудет в точку назначения (квадрат %s) в %dй день, примерно в %s.",		//first %s is mercs name, next is the sector location and name where they will be arriving in, lastely is the day an the time of arrival
...
STR16 pMilitiaButtonsHelpText[] =
{
	...
	L"Убрать (|R|i|g|h|t |C|l|i|c|k)\nДобавить (|L|e|f|t |C|l|i|c|k)\nРядовые",
	L"Убрать (|R|i|g|h|t |C|l|i|c|k)\nДобавить (|L|e|f|t |C|l|i|c|k)\nВетераны",
	L"Равномерно распределить ополчение по доступным квадратам",
};
...
STR16 gzNonPersistantPBIText[] =
{
	...
	L"Войти в квадрат, чтобы продолжить бой. (|E)",
...
STR16 gzLateLocalizedString[] =
{
	...
	//1-5
	L"Робот не сможет покинуть этот квадрат, пока кто-нибудь не возьмет пульт управления.",
	...
	L"Сейчас небезопасно включать сжатие времени - у вас есть наемники в квадрате %s.",
	...
	L"В этом квадрате ополченцев могут тренировать не более %d человек.",	//No more than %d militia trainers are permitted in this sector.
	L"Вы уверены?",
	...
	//55 
	L"Нельзя включить сжатие времени при просмотре предметов в квадрате.",
	...
	L"Невозможно ускорить время - враждебные гражданские или кошки-убийцы в квадрате.", // 65
};

// HEADROCK HAM 3.5: Added sector name
STR16 gzCWStrings[] = 
{
	L"Вызвать подкрепление из соседних квадратов для %s?",
};
...
STR16 New113Message[] =
{
	...
	L"Нельзя строить, пока противник в квадрате!",
	...
	L"Недостаточно минометных снарядов в квадрате для постановки огня!",
...
STR16 New113HAMMessage[] = 
{
	...
	L"Вы не можете тренировать ополчение в этом квадрате.",	//You cannot train militia in this sector.
	L"Ополченец подобрал %s.",	//Militia picks up %s.
	L"Невозможно тренировать ополчение, пока в квадрате враги!",	//Cannot train militia with enemies present!
	// 6 - 10
	L"%s имеет низкий навык Лидерства, чтобы тренировать ополченцев.",	//%s lacks sufficient Leadership score to train militia.
	L"В этом квадрате может быть не больше %d тренеров мобильных групп.",	//No more than %d Mobile Militia trainers are permitted in this sector.
	L"Нет свободных мест в %s или вокруг него для новой мобильной группы!",	//No room in %s or around it for new Mobile Militia!
	L"Нужно иметь по %d ополченцев в каждом освобождённом квадрате города %s, прежде чем можно будет тренировать мобильные группы.",	//You need to have %d Town Militia in each of %s's liberated sectors before you can train Mobile Militia here.
	L"Невозможно назначить занятие, пока враг в квадрате!",	//Can't staff a facility while enemies are present!
	// 11 - 15
	...
	L"Н/Д в этом квадрате",	//N/A in this sector
	L"Дневной расход",
	// 21 - 25
...
STR16 NewInvMessage[] = 
{
	...
	L"Вы уверены, что хотите продать весь хлам этого квадрата голодающему населению Арулько?",
	L"Вы уверены, что хотите выбросить весь хлам, валяющийся в этом квадрате?",
...
STR16 gzFacilityErrorMessage[]=
{
	...
	L"%s потерял(а) часть %s, пока работал в квадрате %s!",
	L"%s потерял(а) часть %s, пока работал над %s в %s!",
	L"%s получил(а) травму, пока работал(а) в квадрате %s, и требует незамедлительной медицинской помощи!",
	L"%s получил(а) травму, пока работал(а) над %s в %s, и требует незамедлительной медицинской помощи!",
	// 21 - 25
	L"%s получил(а) травму, пока работал(а) в квадрате %s. Травма незначительная.",
	...
	L"%s в квадрате %s своими действиями понизил репутацию во всём регионе!",
	// 26 - 30
	L"%s, работая над %s в %s, привёл(а) к понижению репутации во всём регионе!",
	L"%s пьян(а).",
	L"%s заболел(а) в квадрате %s и вынужден(а) отложить текущую задачу.",
	L"%s заболел(а) и не может продолжить работу над %s в %s.",
	L"%s получил(а) травму в квадрате %s.",
	// 31 - 35
	L"%s получил(а) серьёзную травму в квадрате %s.",
...
STR16	gzNewLaptopMessages[]=
{
	...
	L"Ознакомительная игра 'Jagged Alliance 2: Цена Свободы' содержит только первые 6 карт квадратов. Финальная версия игры будет включать в себя гораздо больше возможностей (полная информация содержится в приложенном файле Readme.txt).",
};
...
STR16	zNewTacticalMessages[]=
{
	...
	L"В начале игры вы выбрали режим ''СТАЛЬНЫЕ НЕРВЫ'' и теперь не можете сохраняться во время боя.",
	...
	// anv: extra iron man modes
	L"Это режим режим ''СТАЛЬНЫЕ НЕРВЫ +'' и вы не можете сохраняться в пошаговом режиме.",
	L"Это режим режим ''СТАЛЬНЫЕ НЕРВЫ ++'', сохраняться можно лишь раз в сутки, в %02d:00.",
};
...
STR16	szFoodTextStr[]=
{
	...
	L"Наполнение фляжек в квадрате невозможно, Система Еды отключена!"
};

STR16	szPrisonerTextStr[]=
{
	L"%d офицеров, %d спецназа, %d солдат, %d новобранцев, %d генералов и %d гражданских было допрошено",
...
STR16	szMTATextStr[]=
{
	...
	L"Выбранное укрепление не может быть построено в этом квадрате",
};
...
STR16		szBackgroundText_Flags[]=
{
	...
	L" +1 уровень в подземных квадратах\n",
...
{
	L" %s%d%% ОД в холодных квадратах\n",
	L" %s%d%% ОД в пустынных квадратах\n",	
	L" %s%d%% ОД в болотных квадратах\n",
	L" %s%d%% ОД в городских квадратах\n",
	L" %s%d%% ОД в речных квадратах\n",
	L" %s%d%% ОД в тропических квадратах\n",
	L" %s%d%% ОД в квадратах на побережье\n",
	L" %s%d%% ОД в горных квадратах\n",
	...
	L" %s%d%% ОД на первом ходу при штурме квадрата\n",
...
STR16	szCampaignHistoryDetail[]=
{
	...
	L"Здания в квадрате получили повреждения.",
	L"Во время боя здания в квадрате получили повреждения, %d гражданских были убиты и %d ранены.",
	...
	L"Этот квадрат имеет большое стратегическое значение, поскольку в нем расположена одна из батарей ПВО, которыми располагает армия %s. Аэрофотосьемка показывает, что центр управления получил серьезные повреждения. В результате воздушное пространство над %s некоторое время будет незащищенным.",
...
STR16	szCampaignHistoryResultString[]=
{
	...
	L"Несмотря на численное превосходство повстанцев в этом квадрате, армия легко разделалась с ними.",
